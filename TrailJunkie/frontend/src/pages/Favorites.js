        ...
        <Header>
            <div className='sm:max-w-5xl sm:m-auto font-Outfit'>
                <div className='flex flex-col pt-6 pb-6 pl-3 pr-2'>
                    ...
                    <h1 className='pt-6 pb-6 text-2xl text-center sm:text-4xl sm:text-center'>{currentUser} Favorites</h1>
                    ...
                    {!loading && (
                        <div className='flex flex-col justify-between p-6 space-y-2'>
                            {events.map(event => {
                                return <FavoriteCard key={event.Id} data={event} ownProfile={ownProfile} />;
                            })}
                        </div>
                    )}
                </div>
