        ...
        <div className='sm:max-w-5xl sm:m-auto'>
            ...
            <div className='sm:flex mt-[-70px] sm:mt-0'>
                ...
                <div className='sm:mt-20'>
                    <span className='flex justify-center text-3xl font-bold sm:text-5xl sm:p-0 font-Outfit text-tj-dark-brown'>Welcome Back</span>
                    <p className='p-8 -mt-8 text-xl font-bold text-center sm:text-2xl sm:mt-0 sm:p-0 font-Outfit text-tj-light-brown'>Rediscover the Trails, Relive the Adventures - Your Hiking Community Awaits!</p>
            ...
            <div className='p-8 mx-auto -mt-8 sm:hidden'>
                ...
                {message && <p className={`mb-1 -mt-2 font-bold text-center text-${messageColor}-500 sm:hidden`}>{message}</p>}
                <button className='block w-full p-4 text-xl font-bold text-white rounded-lg shadow-lg bg-tj-dark-brown hover:bg-tj-lightish-brown'
                    onClick={handleLogin}
                >Log In</button>
            </div>
