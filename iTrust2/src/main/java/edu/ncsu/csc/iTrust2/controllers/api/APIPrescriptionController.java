...
public class APIPrescriptionController extends APIController {
    ...
    /**
     * Retrieves a list of all the Prescriptions in the database for the user
     *
     * @param username
     *            Username of the patient
     * @return list of prescriptions
     */
    @GetMapping ( BASE_PATH + "/prescriptions/patientadvocate/{username}" )
    @PreAuthorize ( "hasAnyRole('ROLE_PATIENTADVOCATE')" )
    public List<Prescription> getPrescriptionsPatientAdvocate ( @PathVariable final String username ) {
        ...
        loggerUtil.log( TransactionType.PRESCRIPTION_VIEW, username );
