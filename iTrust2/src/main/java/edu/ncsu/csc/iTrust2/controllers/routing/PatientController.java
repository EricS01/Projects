...
public class PatientController {
    ...
    /**
     * Manages Patient Advocates Through Patients
     *
     * @param model
     *            data for front end
     * @return mapping
     */
    @RequestMapping ( value = "patient/managePatientAdvocates" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String managePatientAdvocates ( final Model model ) {
        return "/patient/managePatientAdvocates";
    }
