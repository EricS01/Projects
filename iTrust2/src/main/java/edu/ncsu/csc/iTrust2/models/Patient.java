...
public class Patient extends User {
    ...
    /** List of PatientAdvocates associated with this Patient */
    @OneToMany ( cascade = CascadeType.ALL, fetch = FetchType.EAGER )
    @LazyCollection ( LazyCollectionOption.FALSE )
    @JsonIgnore
    private List<PatientAdvocateAssociation> associatedPatientAdvocates;
    ...
    public Patient ( final UserForm uf ) {
        ...
        associatedPatientAdvocates = new ArrayList<>();
    }
    ...
    /**
     * Get associated patient advocate list
     *
     * @return the associatedPatientAdvocates
     */
    public List<PatientAdvocateAssociation> getAssociatedPatientAdvocates () {
        return associatedPatientAdvocates;
    }

    /**
     * Add associated patient advocate list
     *
     * @param associatedPatientAdvocate
     *            the associatedPatientAdvocates to set
     */
    public void addAssociatedPatientAdvocates ( final PatientAdvocateAssociation associatedPatientAdvocate ) {
        associatedPatientAdvocates.add( associatedPatientAdvocate );
    }

    /**
     * Remove associated patient advocate list
     *
     * @param associatedPatientAdvocate
     *            the associatedPatientAdvocates to set
     */
    public void removeAssociatedPatientAdvocates ( final PatientAdvocateAssociation associatedPatientAdvocate ) {
        associatedPatientAdvocates.remove( associatedPatientAdvocate );
    }
}
