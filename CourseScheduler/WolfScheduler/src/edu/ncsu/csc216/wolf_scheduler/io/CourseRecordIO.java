...
public class CourseRecordIO {
	...
	/**
	 * reads the course info from file
	 * @param line is a line that is passed
	 * @return Course object from one line
	 * @throws IllegalArgumentException if NoSuchElementException or InputMismatchException are thrown.
	 */
	...
	private static Course readCourse(String line) {
		...
		try {
			...
			String section = stringReader.next();
			int credits = stringReader.nextInt();
			String instructorId = stringReader.next();
			String meetingDays = stringReader.next();
			...
			if("A".equals(meetingDays)) {
				...
				int startTime = stringReader.nextInt();
				int endTime = stringReader.nextInt();
